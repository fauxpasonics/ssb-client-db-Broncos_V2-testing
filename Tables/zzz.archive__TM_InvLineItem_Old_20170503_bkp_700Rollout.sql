CREATE TABLE [zzz].[archive__TM_InvLineItem_Old_20170503_bkp_700Rollout]
(
...
GO
ALTER TABLE [zzz].[archive__TM_InvLineItem_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_InvLi__3213E83FFDB2E225] PRIMARY KEY CLUSTERED  ([id])
GO
