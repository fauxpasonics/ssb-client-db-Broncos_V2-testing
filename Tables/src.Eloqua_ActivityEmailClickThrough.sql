CREATE TABLE [src].[Eloqua_ActivityEmailClickThrough]
(
[ETL_ID] [int] NOT NULL IDENTITY(1, 1),
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__605D434C] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__61516785] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__62458BBE] DEFAULT ((0)),
...
GO
ALTER TABLE [src].[Eloqua_ActivityEmailClickThrough] ADD CONSTRAINT [PK__Eloqua_A__7EF6BFCD273B1651] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
