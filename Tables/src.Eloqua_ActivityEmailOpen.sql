...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__66161CA2] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__670A40DB] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__67FE6514] DEFAULT ((0)),
...
GO
ALTER TABLE [src].[Eloqua_ActivityEmailOpen] ADD CONSTRAINT [PK__Eloqua_A__7EF6BFCD04F7AC1A] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
