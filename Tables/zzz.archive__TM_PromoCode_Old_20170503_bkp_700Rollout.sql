CREATE TABLE [zzz].[archive__TM_PromoCode_Old_20170503_bkp_700Rollout]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Inser__0697FACD] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Updat__078C1F06] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[archive__TM_PromoCode_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Promo__3213E83FC3778541] PRIMARY KEY CLUSTERED  ([id])
GO
