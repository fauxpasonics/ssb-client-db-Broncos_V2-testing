...
[IsDeleted] [bit] NULL,
[DateCreated] [date] NULL CONSTRAINT [DF__Exclusion__DateC__575DE8F7] DEFAULT (getdate()),
[DateUpdated] [date] NULL CONSTRAINT [DF__Exclusion__DateU__58520D30] DEFAULT (getdate())
)
GO
