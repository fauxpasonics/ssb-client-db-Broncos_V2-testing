CREATE TABLE [zzz].[archive__TM_CustAddress_Old_20170503_bkp_700Rollout]
(
...
GO
ALTER TABLE [zzz].[archive__TM_CustAddress_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_CustA__3213E83F89A141C3] PRIMARY KEY CLUSTERED  ([id])
GO
