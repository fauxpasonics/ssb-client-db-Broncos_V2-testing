CREATE TABLE [zzz].[archive__TM_PaySchedule_Old_20170503_bkp_700Rollout]
(
...
GO
ALTER TABLE [zzz].[archive__TM_PaySchedule_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_PaySc__3213E83FC4A3820A] PRIMARY KEY CLUSTERED  ([id])
GO
