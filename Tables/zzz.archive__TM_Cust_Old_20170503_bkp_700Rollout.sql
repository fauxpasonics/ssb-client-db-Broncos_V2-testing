CREATE TABLE [zzz].[archive__TM_Cust_Old_20170503_bkp_700Rollout]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Cust__InsertD__756D6ECB] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Cust__UpdateD__76619304] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL,
[name_type] [nvarchar] (10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [zzz].[archive__TM_Cust_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Cust__3213E83FF3A902DB] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_acct_id] ON [zzz].[archive__TM_Cust_Old_20170503_bkp_700Rollout] ([acct_id])
GO
CREATE NONCLUSTERED INDEX [IDX_UpdateDate] ON [zzz].[archive__TM_Cust_Old_20170503_bkp_700Rollout] ([UpdateDate])
GO
