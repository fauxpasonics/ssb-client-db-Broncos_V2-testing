CREATE TABLE [zzz].[archive__TM_Class_Old_20170503_bkp_700Rollout]
(
...
GO
ALTER TABLE [zzz].[archive__TM_Class_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Class__3213E83F465B9D2F] PRIMARY KEY CLUSTERED  ([id])
GO
