...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__03A67F89] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__049AA3C2] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__058EC7FB] DEFAULT ((0)),
...
GO
ALTER TABLE [src].[Eloqua_ActivityPageView] ADD CONSTRAINT [PK__Eloqua_A__7EF6BFCDC3B7991D] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
