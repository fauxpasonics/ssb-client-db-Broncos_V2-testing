CREATE TABLE [zzz].[archive__TM_Plans_Old_20170503_bkp_700Rollout]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Insert__02C769E9] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Update__03BB8E22] DEFAULT (getdate()),
...
GO
ALTER TABLE [zzz].[archive__TM_Plans_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Plans__3213E83F78F09EB1] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_LoadKey] ON [zzz].[archive__TM_Plans_Old_20170503_bkp_700Rollout] ([event_id], [section_id], [row_id], [seat_num], [ticket_status])
GO
CREATE NONCLUSTERED INDEX [IDX_ticket_status] ON [zzz].[archive__TM_Plans_Old_20170503_bkp_700Rollout] ([ticket_status])
GO
CREATE NONCLUSTERED INDEX [IDX_upd_datetime] ON [zzz].[archive__TM_Plans_Old_20170503_bkp_700Rollout] ([upd_datetime] DESC)
GO
CREATE NONCLUSTERED INDEX [IDX_UpdateDate] ON [zzz].[archive__TM_Plans_Old_20170503_bkp_700Rollout] ([UpdateDate] DESC)
GO
