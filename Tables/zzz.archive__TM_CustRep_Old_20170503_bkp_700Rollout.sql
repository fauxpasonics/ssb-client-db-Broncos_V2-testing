CREATE TABLE [zzz].[archive__TM_CustRep_Old_20170503_bkp_700Rollout]
(
...
GO
ALTER TABLE [zzz].[archive__TM_CustRep_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK_TM_CustRep] PRIMARY KEY CLUSTERED  ([id])
GO
