CREATE TABLE [zzz].[archive__TM_EventsInPlan_Old_20170503_bkp_700Rollout]
(
...
GO
ALTER TABLE [zzz].[archive__TM_EventsInPlan_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Event__3213E83F8FFDB49B] PRIMARY KEY CLUSTERED  ([id])
GO
