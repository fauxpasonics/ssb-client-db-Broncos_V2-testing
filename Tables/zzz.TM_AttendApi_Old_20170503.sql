CREATE TABLE [zzz].[TM_AttendApi_Old_20170503]
(
...
GO
ALTER TABLE [zzz].[TM_AttendApi_Old_20170503] ADD CONSTRAINT [PK__TM_Atten__C4EA24458697527E] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
CREATE NONCLUSTERED INDEX [IDX_LoadKey] ON [zzz].[TM_AttendApi_Old_20170503] ([event_id], [section_id], [row_id], [seat_num])
GO
CREATE NONCLUSTERED INDEX [IDX_result_code] ON [zzz].[TM_AttendApi_Old_20170503] ([result_code])
GO
