CREATE TABLE [ods].[Eloqua_ContactSegment]
(
...
GO
ALTER TABLE [ods].[Eloqua_ContactSegment] ADD CONSTRAINT [PK__Eloqua_C__7EF6BFCD07B4BB20] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
