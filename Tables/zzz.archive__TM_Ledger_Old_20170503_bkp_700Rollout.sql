CREATE TABLE [zzz].[archive__TM_Ledger_Old_20170503_bkp_700Rollout]
(
...
GO
ALTER TABLE [zzz].[archive__TM_Ledger_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Ledge__3213E83F91431DD5] PRIMARY KEY CLUSTERED  ([id])
GO
