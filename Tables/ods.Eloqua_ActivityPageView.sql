...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__02133CD2] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__0307610B] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__03FB8544] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_ActivityPageView] ADD CONSTRAINT [PK__Eloqua_A__3214EC27DCBAA290] PRIMARY KEY CLUSTERED  ([ID])
GO
