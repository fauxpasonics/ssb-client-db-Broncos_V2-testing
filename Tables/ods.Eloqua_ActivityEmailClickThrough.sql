...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__06D7F1EF] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__07CC1628] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__08C03A61] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_ActivityEmailClickThrough] ADD CONSTRAINT [PK__Eloqua_A__3214EC2724E88BB0] PRIMARY KEY CLUSTERED  ([ID])
GO
CREATE NONCLUSTERED INDEX [ix_eloqua_aect_createdat] ON [ods].[Eloqua_ActivityEmailClickThrough] ([CreatedAt]) INCLUDE ([ContactId], [SubjectLine])
GO
