...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Em__ETL_C__2EE5E349] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Em__ETL_U__2FDA0782] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Em__ETL_I__30CE2BBB] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_Email] ADD CONSTRAINT [PK__Eloqua_E__3214EC27C2823214] PRIMARY KEY CLUSTERED  ([ID])
GO
