CREATE TABLE [zzz].[archive__TM_RetailEvent_Old_20170503_bkp_700Rollout]
(
...
GO
ALTER TABLE [zzz].[archive__TM_RetailEvent_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Retai__3213E83FBEA5AAFB] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_HashKey] ON [zzz].[archive__TM_RetailEvent_Old_20170503_bkp_700Rollout] ([HashKey])
GO
CREATE NONCLUSTERED INDEX [IDX_retail_event_id] ON [zzz].[archive__TM_RetailEvent_Old_20170503_bkp_700Rollout] ([retail_event_id])
GO
