CREATE TABLE [zzz].[archive__TM_Tkt_Old_20170503_bkp_700Rollout]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__InsertDa__10216507] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__UpdateDa__11158940] DEFAULT (getdate()),
...
GO
ALTER TABLE [zzz].[archive__TM_Tkt_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Tkt__3213E83E7B21724C] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_LoadKey] ON [zzz].[archive__TM_Tkt_Old_20170503_bkp_700Rollout] ([event_id], [section_id], [row_id], [seat_num], [ticket_status])
GO
CREATE NONCLUSTERED INDEX [IDX_odsTMtkt_seats_tikstat_acctid_eventid_etall] ON [zzz].[archive__TM_Tkt_Old_20170503_bkp_700Rollout] ([num_seats], [ticket_status], [acct_id], [plan_event_id], [seat_num], [section_id], [row_id]) INCLUDE ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_ticket_status] ON [zzz].[archive__TM_Tkt_Old_20170503_bkp_700Rollout] ([ticket_status])
GO
CREATE NONCLUSTERED INDEX [IDX_upd_datetime] ON [zzz].[archive__TM_Tkt_Old_20170503_bkp_700Rollout] ([upd_datetime] DESC)
GO
CREATE NONCLUSTERED INDEX [IDX_UpdateDate] ON [zzz].[archive__TM_Tkt_Old_20170503_bkp_700Rollout] ([UpdateDate] DESC)
GO
