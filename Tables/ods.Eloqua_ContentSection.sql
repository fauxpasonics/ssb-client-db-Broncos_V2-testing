CREATE TABLE [ods].[Eloqua_ContentSection]
(
...
GO
ALTER TABLE [ods].[Eloqua_ContentSection] ADD CONSTRAINT [PK__Eloqua_C__7EF6BFCD96C805B2] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
