...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__0F183235] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__100C566E] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__11007AA7] DEFAULT ((0)),
...
GO
ALTER TABLE [src].[Eloqua_ActivityEmailSend] ADD CONSTRAINT [PK__Eloqua_A__7EF6BFCD1DEE85C0] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
