CREATE TABLE [zzz].[archive__TM_Solicit_Old_20170503_bkp_700Rollout]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Inser__0C50D423] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Updat__0D44F85C] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[archive__TM_Solicit_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Solic__3213E83FEB50B8DD] PRIMARY KEY CLUSTERED  ([id])
GO
