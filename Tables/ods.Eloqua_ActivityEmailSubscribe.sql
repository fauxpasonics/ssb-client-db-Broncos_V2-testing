...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__10615C29] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__11558062] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__1249A49B] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_ActivityEmailSubscribe] ADD CONSTRAINT [PK__Eloqua_A__3214EC27A8532406] PRIMARY KEY CLUSTERED  ([ID])
GO
