CREATE TABLE [zzz].[TM_Ticket_Pacing_Old_20170503]
(
...
GO
ALTER TABLE [zzz].[TM_Ticket_Pacing_Old_20170503] ADD CONSTRAINT [PK_TM_Ticket_Pacing] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
CREATE NONCLUSTERED INDEX [IDX_ETL_BusinessKey] ON [zzz].[TM_Ticket_Pacing_Old_20170503] ([ETL_BusinessKey])
GO
