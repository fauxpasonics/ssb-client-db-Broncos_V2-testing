...
[ETL_CreatedDate] [datetime] NULL CONSTRAINT [DF__TMAPI_Att__ETL_C__12FDD1B2] DEFAULT (getdate()),
...
GO
ALTER TABLE [src].[TMAPI_AttendanceResult] ADD CONSTRAINT [PK__TMAPI_At__7EF6BFCD54035A0E] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
