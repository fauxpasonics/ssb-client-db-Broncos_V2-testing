CREATE TABLE [zzz].[archive__TM_Donation_bkp_700Rollout]
(
...
GO
ALTER TABLE [zzz].[archive__TM_Donation_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Donat__C4EA24459684369E] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
