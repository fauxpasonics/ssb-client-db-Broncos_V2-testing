CREATE TABLE [ods].[Eloqua_ContactListFolder]
(
...
GO
ALTER TABLE [ods].[Eloqua_ContactListFolder] ADD CONSTRAINT [PK__Eloqua_C__7EF6BFCD8F1D40D7] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
