CREATE TABLE [segmentation].[SegmentationFlatDatacc3a9a48-4369-407c-a9e6-16a82d30a0a3]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [ccix_SegmentationFlatDatacc3a9a48-4369-407c-a9e6-16a82d30a0a3] ON [segmentation].[SegmentationFlatDatacc3a9a48-4369-407c-a9e6-16a82d30a0a3]
GO
