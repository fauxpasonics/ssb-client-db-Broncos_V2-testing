CREATE TABLE [zzz].[archive__TM_Journal_Old_20170503_bkp_700Rollout]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Journa__Inser__7D0E9093] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Journa__Updat__7E02B4CC] DEFAULT (getdate()),
...
GO
ALTER TABLE [zzz].[archive__TM_Journal_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Journ__3213E83F40C280E3] PRIMARY KEY CLUSTERED  ([id])
GO
