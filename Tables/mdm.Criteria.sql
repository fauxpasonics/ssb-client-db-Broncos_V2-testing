...
[Custom] [bit] NULL,
[IsDeleted] [bit] NULL,
[DateCreated] [date] NULL CONSTRAINT [DF__Criteria__DateCr__5575A085] DEFAULT (getdate()),
[DateUpdated] [date] NULL CONSTRAINT [DF__Criteria__DateUp__5669C4BE] DEFAULT (getdate()),
