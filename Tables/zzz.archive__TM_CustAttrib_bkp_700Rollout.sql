CREATE TABLE [zzz].[archive__TM_CustAttrib_bkp_700Rollout]
(
...
GO
ALTER TABLE [zzz].[archive__TM_CustAttrib_bkp_700Rollout] ADD CONSTRAINT [PK__TM_CustA__C4EA2445104A08B7] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
