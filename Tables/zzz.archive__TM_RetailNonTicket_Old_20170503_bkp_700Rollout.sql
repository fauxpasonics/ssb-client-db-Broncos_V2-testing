CREATE TABLE [zzz].[archive__TM_RetailNonTicket_Old_20170503_bkp_700Rollout]
(
...
GO
ALTER TABLE [zzz].[archive__TM_RetailNonTicket_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Retai__3213E83F7AA75AEA] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_HashKey] ON [zzz].[archive__TM_RetailNonTicket_Old_20170503_bkp_700Rollout] ([HashKey])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_RetailNonTicket_Old_20170503_bkp_700Rollout] ([SourceFileName])
GO
