CREATE TABLE [ods].[Eloqua_CampaignFolder]
(
...
GO
ALTER TABLE [ods].[Eloqua_CampaignFolder] ADD CONSTRAINT [PK__Eloqua_C__7EF6BFCD0BFC4878] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
