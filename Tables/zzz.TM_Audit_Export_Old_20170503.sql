CREATE TABLE [zzz].[TM_Audit_Export_Old_20170503]
(
...
GO
ALTER TABLE [zzz].[TM_Audit_Export_Old_20170503] ADD CONSTRAINT [PK__TM_Audit__3213E83F727E1C4A] PRIMARY KEY CLUSTERED  ([id])
GO
