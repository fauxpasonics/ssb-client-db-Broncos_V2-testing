CREATE TABLE [zzz].[archive__TM_HeldSeats_Old_20170503_bkp_700Rollout]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Inser__7B264821] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Updat__7C1A6C5A] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[archive__TM_HeldSeats_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_HeldS__3213E83FB297F017] PRIMARY KEY CLUSTERED  ([id])
GO
