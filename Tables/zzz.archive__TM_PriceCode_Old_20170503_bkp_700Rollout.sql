CREATE TABLE [zzz].[archive__TM_PriceCode_Old_20170503_bkp_700Rollout]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Inser__04AFB25B] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Updat__05A3D694] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[archive__TM_PriceCode_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Price__3213E83F79961AAA] PRIMARY KEY CLUSTERED  ([id])
GO
