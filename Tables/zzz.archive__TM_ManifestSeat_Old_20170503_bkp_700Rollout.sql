CREATE TABLE [zzz].[archive__TM_ManifestSeat_Old_20170503_bkp_700Rollout]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Inser__7EF6D905] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Updat__7FEAFD3E] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[archive__TM_ManifestSeat_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Manif__3213E83F93092468] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_BusinessKey] ON [zzz].[archive__TM_ManifestSeat_Old_20170503_bkp_700Rollout] ([manifest_id], [section_id], [row_id], [seat_num])
GO
