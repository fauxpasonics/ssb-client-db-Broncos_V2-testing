CREATE TABLE [zzz].[archive__TM_Arena_Old_20170503_bkp_700Rollout]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Arena__Insert__6FB49575] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Arena__Update__70A8B9AE] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[archive__TM_Arena_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Arena__3213E83F351A544B] PRIMARY KEY CLUSTERED  ([id])
GO
