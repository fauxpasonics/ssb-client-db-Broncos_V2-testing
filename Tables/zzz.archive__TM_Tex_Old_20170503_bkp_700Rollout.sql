CREATE TABLE [zzz].[archive__TM_Tex_Old_20170503_bkp_700Rollout]
(
...
GO
ALTER TABLE [zzz].[archive__TM_Tex_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Tex__3213E83FF7694C64] PRIMARY KEY CLUSTERED  ([id])
GO
