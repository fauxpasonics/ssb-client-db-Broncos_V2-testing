...
GO
CREATE NONCLUSTERED INDEX [IDX_SSBIDHistory_Sourcesystem] ON [mdm].[SSB_ID_History] ([sourcesystem])
GO
CREATE NONCLUSTERED INDEX [IDX_SSBIDHistory_AcctID] ON [mdm].[SSB_ID_History] ([ssb_crmsystem_acct_id]) INCLUDE ([createddate], [sourcesystem], [ssb_crmsystem_contact_id], [SSID])
GO
CREATE NONCLUSTERED INDEX [IDX_SSBIDHISTORY_ContactID_SSID_PriFlag] ON [mdm].[SSB_ID_History] ([ssb_crmsystem_contact_id]) INCLUDE ([ssb_crmsystem_primary_flag], [SSID])
GO
...
GO
CREATE CLUSTERED INDEX [ixc_ssb_id_history] ON [mdm].[SSB_ID_History] ([SSID], [sourcesystem])
GO
