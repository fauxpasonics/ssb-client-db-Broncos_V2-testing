CREATE TABLE [zzz].[archive__TM_AvailSeats_Old_20170503_bkp_700Rollout]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Inser__73852659] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Updat__74794A92] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[archive__TM_AvailSeats_Old_20170503_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Avail__3213E83FF7BE7E98] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_BusinessKey] ON [zzz].[archive__TM_AvailSeats_Old_20170503_bkp_700Rollout] ([event_id], [section_id], [row_id], [seat_num])
GO
