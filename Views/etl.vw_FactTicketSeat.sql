...
Create VIEW [etl].[vw_FactTicketSeat] AS (
...
SELECT
	...
	, fts.SSCreatedBy ArchticsAddUser
...
LEFT OUTER JOIN dbo.FactTicketSaleshistory (NOLOCK) fts ON fi.FactTicketSalesId = fts.FactTicketSalesId
