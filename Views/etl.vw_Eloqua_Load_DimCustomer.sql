...
CREATE VIEW [etl].[vw_Eloqua_Load_DimCustomer] AS (
	...
	, CAST('Dirty' AS NVARCHAR(100)) AS [NameIsCleanStatus]
	, CAST(NULL AS BIGINT) AS [NameMasterId]
	...
	, CAST('Dirty' AS NVARCHAR(100)) AS [AddressPrimaryIsCleanStatus]
	, CAST(NULL AS BIGINT) AS [AddressPrimaryMasterId]
	...
	, CAST('Dirty' AS NVARCHAR(100)) AS [AddressOneIsCleanStatus]
	, CAST(NULL AS BIGINT) AS [AddressOneMasterId]
	...
	, CAST('Dirty' AS NVARCHAR(100)) AS [AddressTwoIsCleanStatus]
	, CAST(NULL AS BIGINT) AS [AddressTwoMasterId]
	...
	, CAST('Dirty' AS NVARCHAR(100)) AS [AddressThreeIsCleanStatus]
	, CAST(NULL AS BIGINT) AS [AddressThreeMasterId]
	...
	, CAST('Dirty' AS NVARCHAR(100)) AS [AddressFourIsCleanStatus]
	, CAST(NULL AS BIGINT) AS [AddressFourMasterId]

	/*Contact*/
	, CAST(NULL AS BINARY(32)) AS [ContactDirtyHash]
	, CAST(NULL as nvarchar(50)) AS [ContactGuid]

	/*Phone*/
	, HASHBYTES('sha2_256',	ISNULL(RTRIM(PhonePrimary),'DBNULL_TEXT')) AS [PhonePrimaryDirtyHash]
	, CAST('Dirty' AS NVARCHAR(100)) AS [PhonePrimaryIsCleanStatus]
	, CAST(NULL AS BIGINT) AS [PhonePrimaryMasterId]
	, HASHBYTES('sha2_256',	ISNULL(RTRIM(PhoneHome),'DBNULL_TEXT')) AS [PhoneHomeDirtyHash]
	, CAST('Dirty' AS NVARCHAR(100)) AS [PhoneHomeIsCleanStatus]
	, CAST(NULL AS BIGINT) AS [PhoneHomeMasterId]
	, HASHBYTES('sha2_256',	ISNULL(RTRIM(PhoneCell),'DBNULL_TEXT')) AS [PhoneCellDirtyHash]
	, CAST('Dirty' AS NVARCHAR(100)) AS [PhoneCellIsCleanStatus]
	, CAST(NULL AS BIGINT) AS [PhoneCellMasterId]
	, HASHBYTES('sha2_256',	ISNULL(RTRIM(PhoneBusiness),'DBNULL_TEXT')) AS [PhoneBusinessDirtyHash]
	, CAST('Dirty' AS NVARCHAR(100)) AS [PhoneBusinessIsCleanStatus]
	, CAST(NULL AS BIGINT) AS [PhoneBusinessMasterId]
	, HASHBYTES('sha2_256',	ISNULL(RTRIM(PhoneFax),'DBNULL_TEXT')) AS [PhoneFaxDirtyHash]
	, CAST('Dirty' AS NVARCHAR(100)) AS [PhoneFaxIsCleanStatus]
	, CAST(NULL AS BIGINT) AS [PhoneFaxMasterId]
	, HASHBYTES('sha2_256',	ISNULL(RTRIM(PhoneFax),'DBNULL_TEXT')) AS [PhoneOtherDirtyHash]
	, CAST('Dirty' AS NVARCHAR(100)) AS [PhoneOtherIsCleanStatus]
	, CAST(NULL AS BIGINT) AS [PhoneOtherMasterId]

	/*Email*/
	, HASHBYTES('sha2_256',	ISNULL(RTRIM(EmailPrimary),'DBNULL_TEXT')) AS [EmailPrimaryDirtyHash]
	, CAST('Dirty' AS NVARCHAR(100)) AS [EmailPrimaryIsCleanStatus]
	, CAST(NULL AS BIGINT) AS [EmailPrimaryMasterId]
	, HASHBYTES('sha2_256',	ISNULL(RTRIM(EmailOne),'DBNULL_TEXT')) AS [EmailOneDirtyHash]
	, CAST('Dirty' AS NVARCHAR(100)) AS [EmailOneIsCleanStatus]
	, CAST(NULL AS BIGINT) AS [EmailOneMasterId]
	, HASHBYTES('sha2_256',	ISNULL(RTRIM(EmailTwo),'DBNULL_TEXT')) AS [EmailTwoDirtyHash]
	, CAST('Dirty' AS NVARCHAR(100)) AS [EmailTwoIsCleanStatus]
	, CAST(NULL AS BIGINT) AS [EmailTwoMasterId]
	/*External Attributes*/
...
*/
		SELECT
			...
			, CAST( C_Date_of_Birth1 AS DATE) AS [Birthday]
			...
			/*AddressPrimary*/
			,  CAST(Address1 AS NVARCHAR(500)) AS [AddressPrimaryStreet]
			, CAST (Address2 AS NVARCHAR(200)) AS [AddressPrimarySuite]
			...
			/*Phone*/
			, CAST(MobilePhone AS NVARCHAR(25)) AS [PhonePrimary]
			...
			/*Email*/
			, CAST(EmailAddress AS NVARCHAR(256)) AS [EmailPrimary]
			...
			, CAST(CreatedBy AS NVARCHAR(255)) AS [SSCreatedBy]
			, CAST(UpdatedBy AS NVARCHAR(255)) AS [SSUpdatedBy]
			...
			, NULL [AccountId]
			, CAST(CASE WHEN LEN(ISNULL(Company,'')) > 0 THEN 1 ELSE 0 END AS BIT) IsBusiness
