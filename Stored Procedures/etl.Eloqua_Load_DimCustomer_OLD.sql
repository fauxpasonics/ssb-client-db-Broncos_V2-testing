...
CREATE PROCEDURE [etl].[Eloqua_Load_DimCustomer_OLD]
...
-- DROP TABLE #tmpETL
SELECT * INTO #tmpETL FROM etl.[vw_Eloqua_Load_DimCustomer]
...
(
		...
		/*, CustomerType, CustomerStatus, AccountType, AccountRep, CompanyName, Birthday, Gender, MergedRecordFlag, MergedIntoSSID, Prefix, FirstName, MiddleName, LastName, Suffix*/
