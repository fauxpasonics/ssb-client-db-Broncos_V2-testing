...
SELECT CAST(NULL AS BINARY(32)) ETL_DeltaHashKey, ID, Name, CreatedAt, Type, AssetId, AssetType, ContactId, Duration, QueryString, QueryStringDisplay, Thread, URL, ReferrerUrl, VisitorExternalId, NumberOfPages, IpAddress, FirstPageViewUrl
INTO #SrcData
