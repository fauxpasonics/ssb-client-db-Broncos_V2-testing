...
SELECT CAST(NULL AS BINARY(32)) ETL_DeltaHashKey, ID, Name, CreatedAt, Type, AssetName, AssetId, AssetType, ContactId, EmailName, EmailWebLink, EmailRecipientId, IPAddress, SubjectLine, CampaignId
INTO #SrcData
